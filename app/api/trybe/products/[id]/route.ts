...
const TRYBE_API_URL = "https://api.try.be/shop/products"
...
// PATCH - Оновити продукт (використовується фронтендом)
export async function PATCH(
  ...
  try {
    ...
    console.log("=== TRYBE PUT REQUEST (via PATCH) ===")
